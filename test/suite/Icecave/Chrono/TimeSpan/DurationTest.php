...
class DurationTest extends PHPUnit_Framework_TestCase
{
    ...
    public function invalidIsoStrings()
    {
        return array(
            ...
            'Years after T time marker'                 => array('PT2Y',                    'Invalid ISO string format: "PT2Y".'),
            'Days after T time marker'                  => array('PT2D',                    'Invalid ISO string format: "PT2D".'),
            'Years and days after T time marker'        => array('PT1Y2M3D',                'Invalid ISO string format: "PT1Y2M3D".'),
